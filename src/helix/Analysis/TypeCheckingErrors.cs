...
namespace Helix.Analysis {
    public static class TypeCheckingErrors {
        ...
        public static Exception InvalidHeapAllocation(TokenLocation location, HelixType type) {
            return new TypeCheckingException(
                location,
        ...
        public static Exception InvalidStackAllocation(TokenLocation location, HelixType type) {
            return new TypeCheckingException(
                location,
        ...
        public static Exception UnexpectedType(TokenLocation location, HelixType expected, HelixType actual) {
            return new TypeCheckingException(
                location,
        ...
        public static Exception UnexpectedType(TokenLocation location, HelixType actual) {
            return new TypeCheckingException(
                location,
                "Analysis Exception: Unexpected type",
        ...
        public static Exception ExpectedVariableType(TokenLocation location, HelixType actual) {
            return new TypeCheckingException(
                location,
        ...
        public static Exception ExpectedFunctionType(TokenLocation location, HelixType actual) {
            return new TypeCheckingException(
                location,
        ...
        public static Exception ExpectedArrayType(TokenLocation location, HelixType actual) {
            return new TypeCheckingException(
                location,
        ...
        public static Exception ExpectedStructType(TokenLocation location, HelixType actual) {
            return new TypeCheckingException(
                location,
        ...
        public static Exception ExpectedUnionType(TokenLocation location, HelixType actual) {
            return new TypeCheckingException(
                location,
        ...
        public static Exception TypeNotCopiable(TokenLocation loc, HelixType type) {
            return new TypeCheckingException(
                loc,
        ...
        public static Exception TypeWithoutDefaultValue(TokenLocation loc, HelixType type) {
            return new TypeCheckingException(
                loc,
        ...
        public static Exception MemberUndefined(TokenLocation loc, HelixType containingType, string memberName) {
            return new TypeCheckingException(
                loc,
        ...
        public static Exception NewObjectMissingFields(TokenLocation loc, HelixType typeName, IEnumerable<string> missingFields) {
        ...
        public static Exception NewObjectHasExtraneousFields(TokenLocation loc, HelixType typeName, IEnumerable<string> extraFields) {
        ...
        public static Exception CircularValueObject(TokenLocation loc, HelixType typeName) {
            return new TypeCheckingException(
                loc,
