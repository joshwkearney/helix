...
public record FunctionDeclaration : IDeclaration {
    ...
    public FunctionDeclaration(TokenLocation loc, ParseFunctionSignature sig, IParseStatement body) {
        this.Location = loc;
        this.signature = sig;
        this.body = body;
    }
    ...
    public TypeCheckResult<IDeclaration> CheckTypes(TypeFrame types) {
        ...
        var result = new TypedTree.Functions.TypedFunctionDeclaration {
