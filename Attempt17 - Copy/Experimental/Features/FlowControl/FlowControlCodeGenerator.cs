...
namespace Attempt17.Experimental.Features.FlowControl {
    public class FlowControlCodeGenerator {
        ...
        public CBlock GenerateWhileSyntax(WhileSyntax<TypeCheckInfo> syntax, ICodeGenerator gen) {
        ...
        public CBlock GenerateIfSyntax(IfSyntax<TypeCheckInfo> syntax, ICodeGenerator gen) {
            var writer = new CWriter();
            var cond = gen.Generate(syntax.Condition);
        ...
        public CBlock GenerateBlockSyntax(BlockSyntax<TypeCheckInfo> syntax, ICodeGenerator gen) {
